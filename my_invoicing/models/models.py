...
class MyInvoicing(models.Model):
    _name = 'my.invoicing'
    _rec_name = "ref"
    ...
    order_line_ids = fields.One2many(comodel_name='order.line', inverse_name='invoicing_id', string="Ligne de commande",)
    ...
    def create(self, values):
        values['ref'] = self.env['ir.sequence'].next_by_code('my.invoicing')
        return super(MyInvoicing, self).create(values)
...
class OrderLine(models.Model):
    ...
    invoicing_id = fields.Many2one(comodel_name='my.invoicing', string='Client', required=False)
...
class Customer(models.Model):
    ...
    bill_ids = fields.One2many(comodel_name='my.invoicing', inverse_name='customers_id', string='Factures')
